...
* Still as user "bitcoin", open it with Nano and paste the configuration below.
  ...
  blockfilterindex=1
  # Support filtering of blocks and transactions with bloom filters # for Bisq
  peerbloomfilters=1
  ...
  # Network
  listen=1
  bind=127.0.0.1 #bind=0.0.0.0 # Replace for Bisq local network connection

  # Enable and proxify all networks through Tor
  listenonion=1
  ...
  whitelist=download@127.0.0.1    # for Electrs/Fulcrum
  ...
  # Initial block download optimizations (remember comment when initial block download has finished)
  dbcache=2000
  blocksonly=1
  ...
  # Tor Node seeds
  #seednode=223viuitp5ig324e5ywq7ul2zyaikpiarbw4qa5tx4f5o5amlqusuwad.onion:8333
  #seednode=23ornybzj5yh4667nqp7tb6f4p3oakelh262uh6xougzpe663eubs4ad.onion:8333
  #seednode=26dclk7xbzy4f6gaspbxzsmhhb332ozcjhaaksyq4x66ia5ckfdsryad.onion:8333
  #seednode=2afixdzfh7h42ivmzroblqz34sa6fxj4tmhlsefayzlkapzp6r6hymyd.onion:8333

  # I2P Node seeds
  #seednode=dbm4jht7uyxgy5h4kpp4t65dwqjykv5kltitbzuhtjm4ccqnrpha.b32.i2p:0
  #seednode=bitcornrd36coazsbzsz4pdebyzvaplmsalq4kpoljmn6cg6x5zq.b32.i2p:0
  #seednode=mjpulaafdyuanouslfpjcsvumi4edtckfu3ffn3ipabkxj4sn35q.b32.i2p:0
