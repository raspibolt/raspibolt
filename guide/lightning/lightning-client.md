...
* As user "admin", download the application, checksums and signature
  ...
  $ wget https://github.com/lightningnetwork/lnd/releases/download/v0.15.4-beta/manifest-roasbeef-v0.15.4-beta.sig
  ```
...
* Verify the signature of the text file containing the checksums for the application
  ...
  ```sh
  $ gpg --verify manifest-roasbeef-v0.15.4-beta.sig manifest-v0.15.4-beta.txt
...
* Install LND
  ...
  $ lnd --version
  > lnd version 0.15.3-beta commit=v0.15.4-beta
  ```
