...
```sh
$ cd /tmp
$ wget https://github.com/lightningnetwork/lnd/releases/download/v0.10.0-beta/lnd-linux-armv7-v0.10.0-beta.tar.gz
$ wget https://github.com/lightningnetwork/lnd/releases/download/v0.10.0-beta/manifest-v0.10.0-beta.txt
$ wget https://github.com/lightningnetwork/lnd/releases/download/v0.10.0-beta/manifest-v0.10.0-beta.txt.sig
$ wget https://keybase.io/roasbeef/pgp_keys.asc

$ sha256sum --check manifest-v0.10.0-beta.txt --ignore-missing
> lnd-linux-armv7-v0.10.0-beta.tar.gz: OK
...
$ tar -xzf lnd-linux-armv7-v0.10.0-beta.tar.gz
$ sudo install -m 0755 -o root -g root -t /usr/local/bin lnd-linux-armv7-v0.10.0-beta/*
$ lnd --version
